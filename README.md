...
| :--- | :--- | :--- | :--- |
| **Module 33** | `m33-first-nextjs-app` | Next.js Setup, Project Structure, Pages | Completed |
| **Module 33** | `m33-next-ts-app` | TypeScript with Next.js & Props Typing | Completed |
| **Module 33** | `m33-rout-practise` | App Router, Dynamic Routing, Layouts | Completed |
| **Module 34** | `m34-data-fetching` | Server & Client Components, Data Fetching | In Progress |
